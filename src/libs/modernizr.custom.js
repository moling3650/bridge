...
window.Modernizr = (function (a, b, c) {
  ...
  var t = []
  var u = t.slice
  var v; var w = function (a, c, d, e) {
    var f; var i; var j; var k; var l = b.createElement('div')
    var m = b.body
...
(function (a, b, c) {
  ...
  function i (a, c, d, e, f, i, j) {
    ...
    y[c] === 1 && (r = 1, y[c] = []), a == 'object' ? l.data = c : (l.src = c, l.type = a), l.width = l.height = '0', l.onerror = l.onload = l.onreadystatechange = function () {
      k.call(this, r)
  ...
  B = function (a) {
    ...
    function g (a, e, f, g, h) {
      ...
      i.url.split('.').pop().split('?').shift(), i.bypass || (e && (e = d(e) ? e : e[a] || e[g] || e[a.split('/').pop().split('?')[0]]), i.instead ? i.instead(a, e, f, g, h) : (y[i.url] ? i.noexec = !0 : y[i.url] = 1, f.load(i.url, i.forceCSS || !i.forceJS && i.url.split('.').pop().split('?').shift() == 'css' ? 'c' : c, i.noexec, i.attrs, i.timeout), (d(e) || d(j)) && f.load(function () {
    ...
    var i; var j; var l = this.yepnope.loader
    if (e(a)) g(a, 0, l, 0)
    ...
    var l; var o; var e = e || B.errorTimeout
    k.src = a
